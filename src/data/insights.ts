...
export const insights: Insight[] = [
  ...
  },
  {
    ...
    frame: "These are not extreme outliers. These are the normal numbers for a belt of states running from the southern Plains through the Deep South. There was nearly one electric or gas shutoff for every 3 utility accounts in Oklahoma.\nThese shutoffs are salt in the wound of $1,800 to $4,000 additional surcharges for each household[^ok-rep-gann-appeal-2025] incurred when gas prices from $2 / MCF  to $1,200 per MCF during 2021 Winter Storm Uri[^green-monies-2022]. If a third of drivers had their license revoked every year, the country would call it a crisis. When it happens to a family’s electricity, we call it business as usual.",
  ...
  },
  {
    ...
    stat: "Alabama shut off gas to 10.05% of gas customers in 2024 about 5x the national gas shutoff rate (2.23%). Arkansas, Mississippi, Tennessee, and Oklahoma all have gas shutoff rates above 5%.",
    frame: "This is what the system looks like when there is almost no effective regulation. Gas is heat. Gas is hot water. Gas fuels the stove that feeds the kids.[^pse-benzene-risk-2025] The people on the other side of the shutoff valve are disproportionately Black, disproportionately poor, and disproportionately in the South. The pattern is not an accident.",
